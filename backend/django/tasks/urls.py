...
urlpatterns = [
    ...
    path('plannings/<int:pk>/update/', views.TaskPlanningUpdateView.as_view(), name='taskplanning-update'),
    path('plannings/<int:pk>/delete/', views.TaskPlanningDeleteView.as_view(), name='taskplanning-delete'),
]
